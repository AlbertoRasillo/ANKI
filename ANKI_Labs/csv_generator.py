...
def main(source_file, swap):
    ...
    # Verificar si se debe intercambiar los valores CSV
    if swap:
        cleaned_lines = swap_csv_values(cleaned_lines)
...
if __name__ == "__main__":
    ...
    parser.add_argument("-swap", action="store_true", help="Intercambia los valores CSV")
    args = parser.parse_args()
    main(args.source_file, args.swap)
